...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCHS):
        for batch_idx, data in enumerate(data_loader):
            ...
            noises = torch.randn(batch_size, 1, 1, 100)
            ...
            if batch_idx % 100 == 0:
                fake = generator(torch.randn(64, 1, 1, 100).cuda()).unsqueeze(1)  # 噪声生成假数据
                path = f"./Generative Adversarial Network/gan/data_new/gpu{epoch+1}_batch{batch_idx+1}.png"
